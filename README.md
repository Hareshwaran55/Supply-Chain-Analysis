...
|---|---|---|
| `supply_chain_data.xlsx` | Full workbook — raw data, calculation sheets, and dashboards | [📥 Download](https://github.com/Hareshwaran55/Supply-Chain-Analysis/raw/main/README.md)|
