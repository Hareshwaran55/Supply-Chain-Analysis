...
[`supply_chain_analysis.py`](supply_chain_analysis.py) (pipeline script) + [`supply_chain_data.xlsx`](supply_chain_data.xlsx) (raw) → [`supply_chain_data_cleaned.xlsx`](supply_chain_data_cleaned.xlsx) (cleaned output)
